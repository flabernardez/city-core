...
function city_register_city_taxonomy() {
	$labels = array(
		'name'                       => _x( 'Regions', 'taxonomy general name', 'city-core' ),
		'singular_name'              => _x( 'Region', 'taxonomy singular name', 'city-core' ),
		'search_items'               => __( 'Search Regions', 'city-core' ),
		'popular_items'              => __( 'Popular Regions', 'city-core' ),
		'all_items'                  => __( 'All Regions', 'city-core' ),
		'edit_item'                  => __( 'Edit Region', 'city-core' ),
		'update_item'                => __( 'Update Region', 'city-core' ),
		'add_new_item'               => __( 'Add New Region', 'city-core' ),
		'new_item_name'              => __( 'New Region Name', 'city-core' ),
		'separate_items_with_commas' => __( 'Separate regions with commas', 'city-core' ),
		'add_or_remove_items'        => __( 'Add or remove regions', 'city-core' ),
		'choose_from_most_used'      => __( 'Choose from the most used regions', 'city-core' ),
		'not_found'                  => __( 'No regions found.', 'city-core' ),
		'no_terms'                   => __( 'No regions', 'city-core' ),
		'menu_name'                  => __( 'Regions', 'city-core' ),
		'items_list_navigation'      => __( 'Regions list navigation', 'city-core' ),
		'items_list'                 => __( 'Regions list', 'city-core' ),
		'back_to_items'              => __( '&larr; Back to Regions', 'city-core' ),
	);
